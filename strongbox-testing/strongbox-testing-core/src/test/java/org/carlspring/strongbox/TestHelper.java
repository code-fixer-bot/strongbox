...
public class TestHelper {
    ...
    public static <I> boolean isOperationSuccessed(Function<I, Boolean> operation, I argument, int millisTimeout, int millisSleepTime) throws InterruptedException {
